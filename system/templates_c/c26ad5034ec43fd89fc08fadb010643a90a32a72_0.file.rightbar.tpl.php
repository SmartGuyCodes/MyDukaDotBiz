<?php
/* Smarty version 3.1.29-dev/14, created on 2021-04-09 12:17:31
  from "/var/www/html/dev.my-duka.com/system/templates/admin/rightbar.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29-dev/14',
  'unifunc' => 'content_607029bb1b7314_69929701',
  'file_dependency' => 
  array (
    'c26ad5034ec43fd89fc08fadb010643a90a32a72' => 
    array (
      0 => '/var/www/html/dev.my-duka.com/system/templates/admin/rightbar.tpl',
      1 => 1474008064,
      2 => 'file',
    ),
  ),
...
function content_607029bb1b7314_69929701 ($_smarty_tpl) {
?>
        ...
        <div class="tab-pane active" id="mmenu-users">
            ...
            <ul class="users-list">
                ...
                <li class="online">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/ici-avatar.jpg" alt>
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        ...
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/arnold-avatar.jpg" alt>
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/peter-avatar.jpg" alt>
                ...
                <li class="online">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/george-avatar.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="busy">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar1.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="busy">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar2.jpg" alt>
                        </a>
                        <div class="media-body">
            ...
            <ul class="users-list">
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar4.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="offline">
                    <div class="media">
                        ...
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar5.jpg" alt>
                        </a>
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar6.jpg" alt>
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar7.jpg" alt>
                        </a>
                        <div class="media-body">
                ...
                <li class="offline">
                    <div class="media">
                        <a class="pull-left profile-photo" href="#">
                            <img class="media-object" src="../../../cdn/admin/assets/images/random-avatar8.jpg" alt>
                        </a>
                        <div class="media-body">
