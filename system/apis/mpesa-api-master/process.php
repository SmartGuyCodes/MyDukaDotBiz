...
$prcsCheckOutReq = new \Api\CheckOut\processCheckOutRequest($app_config["MERCHANT_ID"],"",30020," "," ",$app_config["CALLBACK_URL"],$app_config["CALLBACK_METHOD"]," ");

$response = new \Api\CheckOut\processCheckOutResponse("","","","","");
$response = $checkoutService -> processCheckOut($prcscheckOutReq);
...
//the transaction is processed on mpesa and a callback is executed
