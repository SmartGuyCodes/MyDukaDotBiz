            ...
            <div class="col-lg-12">
                <div class="left-sidebar-title">
                    <ul class="page-menu">
                        ...
                        <li>
                            <a class="active" href="#">My Duka Dot Biz Terms & Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
                <div class="single-latest-blog">
                    <div class="latest-blog-content">
                        ...
                        <h3 style="color: #0D7478 !important;">Introduction</h3>
                        <p>
                            Welcome to myduka.biz website (the "Site"). These terms and conditions ("Terms and Conditions") apply to the Site, and all of its divisions, subsidiaries, and affiliate operated Internet sites which reference these Terms and Conditions.
                        </p>
                        <p>
                        ...
                        <h3 style="color: #0D7478 !important;">Use of the Site</h3>
                        <p>
                        ...
                        <h3 style="color: #0D7478 !important;">Under Submissions</h3>
                        <p>
                        ...
                        <h3 style="color: #0D7478 !important;">Order Acceptance and Pricing</h3>
                        <p>
                        ...
                        <h3 style="color: #0D7478 !important;">Trademarks and Copyrights</h3>
                        <p>
                        ...
                        <h3 style="color: #0D7478 !important;">Arbitration</h3>
                        <p>
                        ...
                        <h3 style="color: #0D7478 !important;">Applicable Law and Jurisdiction</h3>
                        <p>
                        ...
                        <p>
                            My Duka Dot Biz is operated by My Duka Dot Biz Kenya Ltd. ("we"), a company registered in Kenya.
                        </p>

                        <h3 style="color: #0D7478 !important;">Termination</h3>
                        <p>
                            In addition to any other legal or equitable remedies, we may, without prior notice to you, immediately terminate the Terms and Conditions or revoke any or all of your rights granted under the Terms and Conditions. Upon any termination of this Agreement, you shall immediately cease all access to and use of the Site and we shall, in addition to any other legal or equitable remedies, immediately revoke all password(s) and account identification issued to you and deny your access to and use of this Site in whole or in part. Any termination of this agreement shall not affect the respective rights and obligations (including without limitation, payment obligations) of the parties arising before the date of termination. You furthermore agree that the Site shall not be liable to you or to any other person as a result of any such suspension or termination. If you are dissatisfied with the Site or with any terms, conditions, rules, policies, guidelines, or practices of MyDUKA Services in operating the Site, your sole and exclusive remedy is to discontinue using the Site.
                        </p>
                    </div>
                </div>
            </div>
