...
<table width="600" border="0" cellpadding="10" cellspacing="0" style="background:#fff; border:1px solid #ccc;  border-top:7px solid #333;margin:10px auto 0px; padding:0px 10px 10px;">
    <tr>
        <td >
            <p style="padding:15px 0px 0px; margin:0px">Hi {$name},</p>
        </td>
    </tr>
    <tr>
        <td valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="padding:0px 10px 10px 0px; line-height:1.8;">
                <tr>
                    <td>
                        Thank you {$name|default:'My Duka user'}.
                        Your urgent order has been received. Our customer care agent will contact you as soon as possible.
                        Click <a href="https://www.myduka.biz">Here</a> to continue shopping.
                    </td>
                <tr>
                </tr>
            </table>
