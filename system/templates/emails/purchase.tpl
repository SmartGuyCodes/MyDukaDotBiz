    ...
    <tr>
        <td >
            <p style="padding:15px 0px 0px; margin:0px">
                <strong>Dear {$user|default:'My Duka user'},</strong>
            </p>
        </td>
    </tr>
    <tr>
        <td valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="padding:0px 10px 10px 0px; line-height:1.8;">
                <tr>
                    <td>
                        Thanks for choosing to shop with <a href="https://www.myduka.biz">www.myduka.biz</a>.
                        Everything You Need is at My Duka Dot Biz!
                    </td>
                </tr>
                <br/>
                <tr>
                    <td>
                        Your Order Number {$track} has been received and is awaiting
                        confirmation.
                    </td>
                </tr>
                <br/>
