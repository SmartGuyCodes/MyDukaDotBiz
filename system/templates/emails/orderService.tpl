    ...
    <tr>
        <td valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="padding:0px 10px 10px 0px; line-height:1.8;">
                <tr>
                    <td>
                        Order (Order No. {$order}) has been placed by {$user}.
                    </td>
                </tr>
                <br/>
                <tr>
                    <td>
                        Kindly contact {$user} through ({$userMail}) As soon as possible.
                    </td>
                </tr>
                <br/>
                <tr>
                    <td>
                        For any inquiry or suggestion,feel free to contact the Admin through <a href="mailto:admin@myduka">admin@myduka.biz</a> at <a href="mailto:info@myduka.biz">customercare@myduka.biz</a>
                    </td>
                </tr>
                <br/>
                {* <tr>
