...
<table width="600" border="0" cellpadding="10" cellspacing="0" style="background:#fff; border:1px solid #ccc;  border-top:7px solid #17898C;margin:10px auto 0px; padding:0px 10px 10px;">
    <tr>
        <td >
            <p style="padding:15px 0px 0px; margin:0px">Dear Customer Service Agent,</p>
        </td>
    </tr>
    <tr>
        <td valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="padding:0px 10px 10px 0px; line-height:1.8;">
                <tr>
                    <td>
                        {$name} has place an urgent order.
                    </td>
                </tr>
                <br/>
                <tr>
                    <td>
                        Kindly contact {$user} through ({$userMail}) or tel no: {$phone} as soon as possible.
                    </td>
                </tr>
                <br/>
                <tr>
                    <td>
                        For any inquiry or suggestion,feel free to contact the Admin through <a href="mailto:charles@myduka.biz">charles@myduka.biz</a> at <a href="mailto:customercare@myduka.biz">customercare@myduka.biz</a>
                    </td>
                </tr>
                <br/>
                {* <tr>
