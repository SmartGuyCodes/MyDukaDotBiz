                        ...
                        <section class="tile transparent">
                            ...
                            <div class="jumbotron bg-transparent-black-3">
                                <div class="container text-center">
                                    ...
                                    <a href="#add-sub-category" role="button" class="btn btn-red" data-toggle="modal">Add Child Category</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h3 class="modal-title" id="modalConfirmLabel"><strong>New Child Category</strong></h3>
                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" id="new-child-category" action="/{$globals.admin.add_child_category}" method="post" enctype="multipart/form-data">
                            ...
                            <!-- tile header -->
                            <div class="tile-header transparent">
                                <h1><strong>{$category.title}</strong> Categories </h1>
                                <div class="controls">
                                    <a href="#" class="refresh"><i class="fa fa-refresh"></i></a>
                                </div>
                            </div>
                                        ...
                                        {foreach $children as $child}
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="text-center">
                                                    <a href="/{$globals.admin.show_child_categories|cat:($child.url)}" style="color: #fff;">Details</a>
                                                </td>
                                            </tr>
                                        {/foreach}
                                        </tbody>
