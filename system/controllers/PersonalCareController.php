<?php
class PersonalCareController extends CategoryService implements Controller{
    ...
    public function showMain(){
        ...
        $this->assign('items', $productsrv->getCategoryItems('personal-care'));
        $this->assign('title', 'Personal Care');
