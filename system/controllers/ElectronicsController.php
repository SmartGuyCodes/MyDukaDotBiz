<?php
class ElectronicsController extends CategoryService implements Controller{
    ...
    public function showMain(){
        ...
        $this->assign('active', 'electronics');
        $this->assign('total', $total);
        $this->assign('mycart', $cart);
        $this->assign('uId', $_SESSION[MD_OWNER]);

        $this->assign('items', $productsrv->getCategoryItems('consumer-electronics'));
        $this->assign('title', 'Consumer Electronics');
