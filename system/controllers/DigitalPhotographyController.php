<?php
class DigitalPhotographyController extends CategoryService implements Controller{
    ...
    public function showMain(){
        ...
        $this->assign('items', $productsrv->getCategoryItems('cameras'));
        ...
        $this->assign('active', 'digital');
        $this->assign('total', $total);
        $this->assign('mycart', $cart);
        $this->assign('uId', $_SESSION[MD_OWNER]);
        $this->assign('title', 'Digital Photography');
